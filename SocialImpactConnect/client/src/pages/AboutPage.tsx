      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold text-gray-900">About HelpingHands</h1>
            ...
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-600">
                  Founded in 2010, HelpingHands began as a small group of volunteers committed to addressing the educational needs of underprivileged children in local communities. What started as a simple school supplies drive quickly evolved as we recognized the interconnected challenges facing vulnerable populations.
                </p>
                <p className="text-gray-600">
                ...
                <p className="text-gray-600">
                  Today, HelpingHands operates nationwide with a network of dedicated volunteers, partners, and donors who share our commitment to empowering communities and building a more equitable society for all.
                </p>
              </div>
            </div>
          ...
          <div>
            ...
            <p className="text-center text-gray-600 max-w-3xl mx-auto mb-10">
              HelpingHands is powered by a dedicated team of staff and volunteers committed to our mission of creating positive change in communities.
            </p>
