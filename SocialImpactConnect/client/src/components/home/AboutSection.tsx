      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:flex lg:items-center lg:space-x-12">
          <div className="lg:w-1/2">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">About HelpingHands</h2>
            <p className="text-lg text-gray-600 mb-6">
              HelpingHands is a social welfare organization dedicated to improving the lives of vulnerable communities through sustainable development initiatives and immediate assistance during times of need.
            </p>
            <p className="text-lg text-gray-600 mb-6">
